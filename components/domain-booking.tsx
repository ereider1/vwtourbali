  ...
  return (
    <section id="contact" className="paper-edge relative overflow-hidden bg-[#263b27] py-28 text-white">
      ...
      <div className="container-max container-padding relative z-10 grid gap-10 lg:grid-cols-[1.35fr_.65fr] lg:items-end">
        ...
        <div className="lg:text-right"><a href="https://wa.me/6281237812783" className="btn-primary bg-[#79924f] px-8 py-4">Plan on WhatsApp <span aria-hidden>↗</span></a><p className="mt-5 text-xs leading-5 text-white/50">Usually replies within a few hours<br />+62 812 3781 2783</p></div>
      </div>
    </section>
  );
}
