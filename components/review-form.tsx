  ...
  if (submitted) {
    return (
      <div className="min-h-[560px] bg-[#263b27] p-8 text-white shadow-[0_24px_70px_rgb(30_42_25/0.14)] sm:p-12">
        ...
        <p className="mt-7 max-w-lg text-sm leading-7 text-white/65">WhatsApp should have opened with your review ready to send. Just tap send and it will reach Bobby and the team.</p>
